...
#define MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE                              512                                                                                              // set by application[*]
...
#define MBED_CONF_IDW0XX1_EXPANSION_BOARD                                     IDW01M1                                                                                          // set by application[*]
#define MBED_CONF_IDW0XX1_PROVIDE_DEFAULT                                     1                                                                                                // set by application[*]
#define MBED_CONF_IDW0XX1_RX                                                  PA_10                                                                                            // set by application[*]
#define MBED_CONF_IDW0XX1_TX                                                  PA_9                                                                                             // set by application[*]
